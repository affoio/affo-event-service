...
1. Fork `the repository <https://github.com/affo/affo-event-service>`_ and clone the fork.
...
When `reporting a bug <https://github.com/affo/affo-event-service/issues>`_
please include:

    * Operating system name and version.
    * `affo-event-service` version.
...
`Github <https://github.com/affo/affo-event-service/issues>`_. If you are proposing a feature:
